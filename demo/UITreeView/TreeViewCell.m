...
- (id)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self) {
        ...
        checkBox.uncheckedImage = [UIImage imageNamed:@"check_box"];
        ...
        if (isFolder) {
            arrowImageButton.checkedImage = [UIImage imageNamed:@"check_box"];
            arrowImageButton.uncheckedImage = [UIImage imageNamed:@"check_box"];
        } else {
            arrowImageButton.checkedImage = [UIImage imageNamed:@"expandableImage@2x"];
            arrowImageButton.uncheckedImage = [UIImage imageNamed:@"expandableImage@2x"];
        }
